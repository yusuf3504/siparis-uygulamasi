        ...
        <div className='header'>
            ...
            <div className='slider'>
                <div className='slides' style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                    <div className='slide'>
                        <img src="https://www.drtaneryavuz.com/wp-content/uploads/2019/09/%C3%87ocuklar-%C4%B0%C3%A7in-Sa%C4%9Fl%C4%B1kl%C4%B1-%C4%B0%C3%A7ecekler.jpg" alt="Image 1" />
                    </div>
                    <div className='slide'>
                        <img src="https://www.altunmarket.com/app/assets/home/img/blog/asitli-min.jpg" alt="Image 2" />
                    </div>
                    <div className='slide'>
                        <img src="https://www.bobajoy.com.tr/data/haber/QelOWQHhi1buj8dP.jpg" alt="Image 3" />
                    </div>
                    <div className='slide'>
                        <img src="https://yasamgazetesicomtr.teimg.com/crop/1280x720/yasamgazetesi-com-tr/uploads/2023/07/evde-yapilabilecek-dogal-soguk-icecekler.jpg" alt="Image 4" />
                    </div>
                </div>
            </div>
                ...
                <div className="list-wrapper">
                    <ul className="list-select">
                        <li className="list-item">
                            <img src="https://gizemtuncturk.com/wp-content/uploads/2023/08/Adsiz-tasarim-5.png"
                                alt="" className="list-img" />
                            <span className="list-title">Maden suyu</span>
                            <button className="btn-buy" onClick={() => addToCart('Maden suyu', 20)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li className="list-item">
                            <img src="https://blog.secmarket.com.tr/wp-content/uploads/2024/04/evde-yapabileceginiz-katkisiz-meyve-sulari-1.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Meyve suyu</span>
                            <button className="btn-buy" onClick={() => addToCart('Meyve Suyu', 30)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li className="list-item">
                            <img src="https://www.sariyermarket.com/images/thumbs/0033325_fuse-tea-soguk-cay-karpuz-aromali-cecek-kutu_510.jpeg"
                                alt="" className="list-img" />
                            <span className="list-title">Soğuk Çay</span>
                            <button className="btn-buy" onClick={() => addToCart('Soğuk Çay', 18)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li className="list-item">
                            <img src="https://ardenmarket.com.tr/media/catalog/product/cache/ce320e98947e5c83f08a8e256dc8423e/_/i/_im_ayran_200_ml.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Ayran</span>
                            <button className="btn-buy" onClick={() => addToCart('Ayran', 12)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li className="list-item">
                            <img src="https://cdn.myikas.com/images/4fe7a638-08b1-4511-af04-b1e5c46eff18/0029026b-46be-4a90-a184-350c7c285273/image_1080.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Türk Kahvesi</span>
                            <button className="btn-buy" onClick={() => addToCart('Türk Kahvesi', 80)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li className="list-item">
                            <img src="https://images.migrosone.com/macrocenter/product/08113143/8113143-a0448d.png"
                                alt="" className="list-img" />
                            <span className="list-title">Enerji İçeçeği</span>
                            <button className="btn-buy" onClick={() => addToCart('Enerji İçeçeği', 50)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                    </ul>
