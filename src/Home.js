    ...
    useEffect(() => {
        ...
        arrows.forEach((arrow, i) => {
            ...
            arrow.addEventListener('click', () => {
                ...
                if (imagesCount - (3 + clickCounter) + (3 - widthRatio) >= 0) {
...
listWrapper.forEach(wrapper => {
    ...
    wrapper.addEventListener('mousemove', (e) => {
        ...
        const walk = (x - startX) * 3; // The multiplier increases scroll speed
    ...
    return (
        <div className='header'>
            ...
            <p class="featured-desc">
                 <h1>NE İSTERSEN'le Aklındaki Kapına Gelsin Hem de İstediğin Zaman İstediğin Yerde.</h1>
                </p>
            ...
            <div className='list-container'>
                <h2 className='list-baslık'>Kategoriler</h2>
                <div className="list-wrapper">
                    <ul className="list-select">
                        <li className="list-item">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR143ZbBF8GL5vk-weXF-_EKKMQYLuYIn6aRg&s"
                                alt="" className="list-img" />
                            <span className="list-title">Dondurma</span>
                           
                        </li>
                        <li className="list-item">
                            <img src="https://www.pratikdepo.com/blog/wp-content/uploads/2022/08/Es%CC%A7ya-Depolama-Sayesinde-Genis%CC%A7-Alanlar-1140x641.webp"
                                alt="" className="list-img" />
                            <span className="list-title">Ev ve Yaşam</span>
                           
                        </li>
                        <li className="list-item">
                            <img src="https://m.media-amazon.com/images/I/71iBKcLHXFL.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Elektronik</span>
                           
                        </li>
                        <li className="list-item">
                            <img src="https://www.petaddress.com.tr/wp-content/uploads/2021/01/evcil-hayvnalar-nerede-satilir.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Evcil Hayvanlar</span>
                          
                        </li>
                        <li className="list-item">
                            <img src="https://www.karaca.com/blog/wp-content/uploads/2022/11/airfryer4.webp"
                                alt="" className="list-img" />
                            <span className="list-title">Yemekler</span>
                            
                        </li>
                        <li className="list-item">
                            <img src="https://cantanrikulu.com/wp-content/uploads/2020/12/en-iyi-dis-macunu-markalari.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Kişisel Bakım</span>
            ...
            <div className='list-container'>
                <div className="list-wrapper">
                    <ul className="list-select">
                        <li className="list-item">
                            <img src="https://www.sloganlar.org/wp-content/uploads/2018/07/su-ile-ilgili-sloganlar.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Su ve 
                                içeçekler
                            </span>
                      
                        </li>
                        <li className="list-item">
                            <img src="https://www.egricayir.com/resimler/resimler/balli_sut_nedir_nasil_yapilir_1648884557.png"
                                alt="" className="list-img" />
                            <span className="list-title">Süt Ürünleri</span>
                         
                        </li>
                        <li className="list-item">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDPVSrj-ePI58FX9DTKD86cTXbMvPlJEdMtQ&s"
                                alt="" className="list-img" />
                            <span className="list-title">Et,Tavuk ve Balık</span>
                           
                        </li>
                        <li className="list-item">
                            <img src="https://i0.wp.com/blog.entazem.com/wp-content/uploads/2024/10/meyve.webp?fit=1280%2C720&ssl=1"
                                alt="" className="list-img" />
                            <span className="list-title">Meyve Sebze</span>
                           
                        </li>
                        <li className="list-item">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTI0f8sIL3SXj5aQZNwDkqOiD4r31U92IrWj78kXWl0eKFBVhNE2JzfKB3Vcq_45WKFDzQ&usqp=CAU"
                                alt="" className="list-img" />
                            <span className="list-title">Temizlik seti</span>
                       
                        </li>
                        <li className="list-item">
                            <img src="https://www.ozerymm.com/wp-content/uploads/2022/09/KDV-61.jpg"
                                alt="" className="list-img" />
                            <span className="list-title">Temel Gıdalar</span>
