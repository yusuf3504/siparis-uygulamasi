...
export default function Yemek({ onSelectCategory }) {
    ...
    arrows.forEach((arrow, i) => {
        ...
        arrow.addEventListener('click', () => {
            clickCounter++;
            let currentTransform = parseFloat(getComputedStyle(listselects[i]).transform.split(',')[4]) || 0;
            ...
            if (imagesCount - (4 + clickCounter) + (4 - widthRatio) >= 0) {
                ...
                clickCounter = 0;
                currentTransform = 0;  // `currentTransform` değerini sıfırlıyoruz
            }
        });
    });
        ...
        <div className='header'>
            ...
            <div className='slider'>
                <div className='slides' style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                    <div className='slide'>
                        <img src="https://dergice.com/wp-content/uploads/2020/03/cigkofte.jpg" alt="Image 1" />
                    </div>
                    <div className='slide'>
                        <img src="https://www.karaca.com/blog/wp-content/uploads/2022/11/airfryer4.webp" alt="Image 2" />
                    </div>
                    <div className='slide'>
                        <img src="https://www.sweetandsavourypursuits.com/wp-content/uploads/2022/07/Chicken-Shawarma-Kebabs-1200-x-1200-2.jpg" alt="Image 3" />
                    </div>
                    <div className='slide'>
                        <img src="https://img.piri.net/mnresize/900/-/resim/imagecrop/2024/12/28/12/58/resized_cd146-3eb6210c120241228t005414.jpg" alt="Image 4" />
                    </div>
                </div>
            </div>
            <div className='list-container'>
                <div class="list-wrapper">
                    <ul class="list-select">
                        <li class="list-item">
                            <img src="https://www.lepleziz.com/images/content/kolay-su-boregi_mpx7.webp"
                                alt="" class="list-img" />
                            <span class="list-title">Börek</span>
                            <button className="btn-buy" onClick={() => addToCart('Börek', 70)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li class="list-item">
                            <img src="https://cdn.getiryemek.com/restaurants/1623652149855_1125x522.jpeg"
                                alt="" class="list-img" />
                            <span class="list-title">Burger</span>
                            <button className="btn-buy" onClick={() => addToCart('Burger', 120)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li class="list-item">
                            <img src="https://images.deliveryhero.io/image/fd-tr/LH/oh2w-listing.jpg"
                                alt="" class="list-img" />
                            <span class="list-title">Döner</span>
                            <button className="btn-buy" onClick={() => addToCart('Döner', 50)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li class="list-item">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS82aZAsppgoOWRH0iADyPDbDfQrX4amk-zmw&s"
                                alt="" class="list-img" />
                            <span class="list-title">Lahmacun</span>
                            <button className="btn-buy" onClick={() => addToCart('Lahmacun', 80)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li class="list-item">

                            <img src="https://cookingorgeous.com/wp-content/uploads/2021/06/lamb-shish-kebab-20.jpg"
                                alt="" class="list-img" />
                            <span class="list-title">Kebab</span>
                            <button className="btn-buy" onClick={() => addToCart('Kebab', 100)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                        <li class="list-item">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTg2zvw3-u-oIEwTm4l5_g72B_J9D5zxWs88Q&s"
                                alt="" class="list-img" />
                            <span class="list-title">Hamsi Tava</span>
                            <button className="btn-buy" onClick={() => addToCart('Hamsi Tava', 130)}><i className="bi bi-plus"></i> SEPETE EKLE</button>
                        </li>
                    </ul>
            ...
            <div class="footerMenus">
                ...
                <div class="shpadding-reset"><a href="/aksesuar-c-1802" class=""><span class="üstbaslık">YEMEKLER</span></a>
                    <ul class="footerMenu footerMenu-1 hidden-md-down">
                        ...
                        <li><a href="/suruplar-c-3406" class="">Kebab</a></li>
                    </ul>
                </div>
